...
export default class Inventario{
    ...
    agregarObjeto(objeto){
        ...
        }else if(((objeto.tipo==="armadura" || objeto.tipo==="escudo") && this.#defensa.length<5)){
            this.#defensa.push(objeto);
        }else if(objeto.tipo==="amuleto" && this.#amuletos.length<5 ){
                this.#amuletos.push(objeto);
        }else if(objeto.efecto==="salud"&& this.#pocionesVida.length<8){
                this.#pocionesVida.push(objeto);
        }else if(objeto.efecto==="mana" && this.#pocionesMana.length<8){
