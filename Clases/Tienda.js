    ...
    obtenerArmasPorRaza(raza){
        switch(raza){
            ...
            return [   //Armas de Humanos
                new Arma("Espada del Rey Caído 👑⚔️","Una hoja legendaria que brilla con la voluntad de su portador.",100,800,6,"humano","./Imagenes/humanos/espada_rey.png"),
                new Arma("Lanza Relámpago ⚡🏹"," Puede arrojarse y volver a la mano del usuario.",100,700,5,"humano","./Imagenes/humanos/lanza_relampago.png"),
                new Arma("Maza Bendecida 🛡️🔨","Un arma con poder sagrado que quema a los no-muertos.",115,750,6,"humano","./Imagenes/humanos/maza_bendecida.png"),
                new Arma("Ballesta de Triple Disparo 🎯🔫"," Dispara tres proyectiles a la vez, ideal para eliminar múltiples enemigos.",70,900,7,"humano","./Imagenes/humanos/ballesta.png"),
                new Arma("Dagas de Sombra 🕶️🗡️","Permiten moverse sin ser visto por breves instantes.",100,750,6,"humano","./Imagenes/humanos/dagaSombra.png"),
            ...
            return [//Armas de Orcos
                new Arma("Hacha Sangrienta 🩸🪓","Se vuelve más poderosa con cada golpe que da.",110,850,7,"orco","./Imagenes/orcos/hacha_sangrienta.png"),
                new Arma("Maza de Guerra de Cráneos 💀🔨","Hecha con los huesos de enemigos caídos, aterradora en combate.",120,950,8,"orco","./Imagenes/orcos/maza_de_guerra.png"),
                new Arma("Espada Serrada 🔪💢","Una espada con dientes afilados que desgarran la carne al cortar.",110,750,6,"orco","./Imagenes/orcos/espada_serrada.png"),
                new Arma("Lanza de Colmillos de Bestia 🐺🏹","Hecha con los colmillos de un monstruo gigante, sus heridas son letales.",105,800,7,"orco","./Imagenes/orcos/lanza_colmillos.png"),
                new Arma("Garrote de Lava 🌋🔥","Un arma cubierta de roca volcánica que arde al golpear.",150,1000,9,"orco","./Imagenes/orcos/garrote_lava.png"),
            ...
            return [    //Armas de Magos
                new Arma("Báculo de Tormentas ⚡🌀","Un bastón que controla truenos y vientos, devastador contra grupos de enemigos.",110,750,6,"mago","./Imagenes/magos/baculo_de_tormentas.png"),
                new Arma("Varita de Llamas Eternas 🔥📜","Lanza fuego sin necesidad de palabras mágicas, perfecta para hechiceros agresivos.",105,600,5,"mago","./Imagenes/magos/varita_llamas.png"),
                new Arma("Orbe del Vacío ⚫🌌","Una esfera que absorbe energía y la libera como un rayo devastador.",120,800,7,"mago","./Imagenes/magos/orbe_del_vacio.png"),
                ...
                new Arma("Espada del Arcano 🌀⚔️","Una espada flotante que se maneja con la mente.",95,750,6,"mago","./Imagenes/magos/espada_arcano.png"),
            ...
            return [    //Armas de Enanos
                new Arma("Martillo Rompemontañas 🪨🔨","Un martillo de guerra tan pesado que solo un enano puede levantarlo. Golpea con la fuerza de una avalancha.",120,500,5,"enano","./Imagenes/enanos/martillo_rompemontanhas.png"),
                new Arma("Hacha de Tormenta ⚡🪓", "Un hacha con runas grabadas que lanza rayos al impactar. Ideal contra enemigos con armaduras metálicas.",120,600,6,"enano","./Imagenes/enanos/hacha_tormenta.png"),
                new Arma("Martillo Lanzarrocas 🏹💥", "Un martillo que puede arrojar pequeños proyectiles de roca al golpear el suelo, afectando a múltiples enemigos a la vez.", 105,450,4,"enano","./Imagenes/enanos/martillo_lanzarrocas.png"),
                new Arma("Escudo-Mandoble 🛡️⚔️","Un escudo grande que esconde una espada oculta en su centro. Puede resistir golpes letales y sorprender con un ataque inesperado.",50,700,7,"enano","./Imagenes/enanos/escudo_mandoble.png"),
            ...
            return [//Armas de Elfos
                    new Arma("Arco de Luz Lunar 🌙🏹","Un arco que dispara flechas de energía pura en la oscuridad, ideal para combates nocturnos.",110,600,5,"elfo","./Imagenes/elfos/arco_luz_lunar.png"),
                    new Arma("Espadas Danzantes 🌿⚔️"," Dos dagas que se pueden lanzar y regresan solas como un búmeran, perfectas para combates rápidos.",70,550,4,"elfo","./Imagenes/elfos/espadas_danzantes.png"),
                    new Arma("Lanza del Viento 🍃🌀","Una lanza liviana que se mueve con el aire y permite ataques veloces.",90,500,4,"elfo","./Imagenes/elfos/lanza_viento.png"),
                    new Arma("Flechas de Enredaderas 🌱🎯","Flechas que al impactar hacen crecer raíces para atrapar al enemigo.",80,450,3,"elfo","./Imagenes/elfos/flecha_enredaderas.png"),
                    new Arma("Bastón de Espíritus del Bosque 🌳✨","Un arma mágica que permite invocar bestias o curar aliados.",50,700,6,"elfo","./Imagenes/elfos/baston_espiritus_bosque.png"),
