    ...
    constructor(raza){
        ...
        this.#protecciones={
            escudo:[ //Protecciones tipo Escudo
                ...
                new Proteccion("Escudo de la Rosa de Acero 🌹🛡️", "Un escudo bello pero letal, resistente como el acero y símbolo de valor.", "escudo", 16, 370, 1.32, "./Imagenes/Protecciones_Pociones/escudo_rosa_acero.png"),
                new Proteccion("Escudo del Infinito ∞🛡️", "Hecho con materiales de otro plano, absorbe parte del daño y aumenta la energía mágica.", "escudo", 22, 550, 1.45, "./Imagenes/Protecciones_Pociones/escudo_infinito.png"),
                new Proteccion("Escudo del Guardabosques 🌲🛡️", "Forjado con madera sagrada, este escudo es ligero y otorga velocidad al portador.", "escudo", 14, 300, 1.25, "./Imagenes/Protecciones_Pociones/escudo_guardabosques.png"),
                new Proteccion("Escudo de Hielo Eterno ❄️🛡️", "Congela brevemente al atacante al recibir golpes, ideal para defensas estratégicas.", "escudo", 19, 480, 1.38, "./Imagenes/Protecciones_Pociones/escudo_hielo.png"),
                new Proteccion("Escudo del Juicio Final ⚖️🛡️", "Capaz de reflejar los ataques más poderosos, este escudo está reservado para los elegidos.", "escudo", 28, 700, 1.60, "./Imagenes/Protecciones_Pociones/escudo_juicio.png")
            ],
            armadura:[ //Protecciones tipo Armadura
                ...
                new Proteccion("Armadura del Fénix 🔥🕊️", "Revivida de las cenizas, esta armadura otorga defensa y una segunda oportunidad al caer.", "armadura", 38, 750, 1.78, "./Imagenes/Protecciones_Pociones/armadura_fenix.png"),
                new Proteccion("Armadura de Escarcha❄️", "Esta armadura ralentiza a los enemigos al contacto y protege contra ataques elementales.", "armadura", 28, 580, 1.55, "./Imagenes/Protecciones_Pociones/armadura_escarcha.png"),
                new Proteccion("Armadura de la Rey de la Noche 👑🌙", "Confeccionada con seda lunar y acero negro, brinda gran defensa y evasión.", "armadura", 32, 690, 1.65, "./Imagenes/Protecciones_Pociones/armadura_rey_noche.png"),
                new Proteccion("Armadura de Gaia 🌍", "Fusionada con el poder de la tierra, reduce daño físico y mejora la resistencia al veneno.", "armadura", 34, 720, 1.68, "./Imagenes/Protecciones_Pociones/armadura_gaia.png"),
                new Proteccion("Armadura del Guardián del Abismo 🕳️🛡️", "Absorbe la oscuridad del enemigo y la transforma en fuerza defensiva.", "armadura", 36, 770, 1.72, "./Imagenes/Protecciones_Pociones/armadura_guardian.png")
            ],
            amuleto:[//Protecciones tipo Magia
                ...
                new Proteccion("Amuleto de la Luna Azul 🌙🔷", "Potenciado por la energía lunar, mejora la defensa mágica y regenera maná rápidamente.", "amuleto", 10, 320, 1.28, "./Imagenes/Protecciones_Pociones/amuleto_luna_azul.png"),
                new Proteccion("Amuleto del Vacío 🌀", "Canaliza energía del vacío, reduciendo daño mágico y aumentando resistencia al caos.", "amuleto", 13, 420, 1.38, "./Imagenes/Protecciones_Pociones/amuleto_vacio.png"),
                new Proteccion("Amuleto del Espíritu Guardián 👻🔮", "Invoca un espíritu protector que bloquea parte del daño mágico recibido.", "amuleto", 11, 360, 1.32, "./Imagenes/Protecciones_Pociones/amuleto_espiritu_guardian.png"),
                new Proteccion("Amuleto de Luz Divina ✨💎", "Repele maldiciones y proporciona regeneración de vida al recibir daño mágico.", "amuleto", 14, 460, 1.42, "./Imagenes/Protecciones_Pociones/amuleto_luz_divina.png"),
                new Proteccion("Amuleto del Oráculo 🔮👁️", "Permite prever ataques mágicos, otorgando evasión mágica y velocidad de reacción.", "amuleto", 16, 520, 1.50, "./Imagenes/Protecciones_Pociones/amuleto_oraculo.png")
            ]
        };
        this.#pociones={
    ...
    obtenerArmasPorRaza(raza){
        switch(raza){
            ...
            return [   //Armas de Humanos
                ...
                new Arma("Arco de la Caza Real 🏹👑", "Un arco impresionante con un alcance letal y una puntería infalible.", 2.1, 700, 3, "humano", "./Imagenes/humanos/arco_caza.png"),
                new Arma("Lanza Relámpago ⚡🏹"," Puede arrojarse y volver a la mano del usuario.",2.0,700,4,"humano","./Imagenes/humanos/lanza_relampago.png"),
                new Arma("Espada de la Luz Celestial 🌟⚔️", "Un sable forjado con la luz pura, ideal para desintegrar sombras.", 2.0, 850, 5, "humano", "./Imagenes/humanos/celestial.png"),
                ...
                new Arma("Maza Bendecida 🛡️🔨","Un arma con poder sagrado que quema a los no-muertos.",2.15,750,7,"humano","./Imagenes/humanos/maza_bendecida.png"),
                new Arma("Dagas de Sombra 🕶️🗡️","Permiten moverse sin ser visto por breves instantes.",2.0,750,8,"humano","./Imagenes/humanos/dagaSombra.png"),
                new Arma("Ballesta de Triple Disparo 🎯🔫"," Dispara tres proyectiles a la vez, ideal para eliminar múltiples enemigos.",1.7,900,9,"humano","./Imagenes/humanos/ballesta.png"),
                new Arma("Espada de los Vientos Silenciosos 🌬️⚔️", "Una espada tan ligera que corta como el viento, casi invisible al movimiento.", 1.9, 750, 9,"humano", "./Imagenes/humanos/espada_vientos.png"),
                
                new Arma("Mandoble del Honor Perdido ⚔️🕊️", "Empapado en historias de traición y redención.", 2.05, 820, 6, "humano", "./Imagenes/humanos/mandoble_honor.png"),
                new Arma("Cetro de Comando Imperial 🎖️🔱", "Símbolo de autoridad, permite coordinar tropas mágicamente.", 1.85, 780, 7, "humano", "./Imagenes/humanos/cetro_imperial.png"),
                new Arma("Espada Rúnica del Inquisidor 🔥🗡️", "Quema con runas antiguas que purifican el mal.", 2.2, 900, 8, "humano", "./Imagenes/humanos/espada_inquisidor.png"),
                new Arma("Ballesta de Energía Solar 🌞🎯", "Dispara rayos concentrados de luz solar.", 2.0, 1000, 9, "humano", "./Imagenes/humanos/ballesta_solar.png"),
                new Arma("Lanza del Juicio Final ⚖️🔥", "Cae como un relámpago sobre el enemigo culpable.", 2.3, 1100, 10, "humano", "./Imagenes/humanos/lanza_juicio.png")
            ...
            return [//Armas de Orcos
                ...
                new Arma("Espada Serrada 🔪💢","Una espada con dientes afilados que desgarran la carne al cortar.",2.10,750,4,"orco","./Imagenes/orcos/espada_serrada.png"),
                new Arma("Lanza de Colmillos de Bestia 🐺🏹","Hecha con los colmillos de un monstruo gigante, sus heridas son letales.",2.05,800,5,"orco","./Imagenes/orcos/lanza_colmillos.png"),
                new Arma("Hacha Sangrienta 🩸🪓","Se vuelve más poderosa con cada golpe que da.",2.10,850,6,"orco","./Imagenes/orcos/hacha_sangrienta.png"),
                new Arma("Maza de Guerra de Cráneos 💀🔨","Hecha con los huesos de enemigos caídos, aterradora en combate.",2.20,950,7,"orco","./Imagenes/orcos/maza_de_guerra.png"),
                ...
                new Arma("Mandoble de Ira Pura 💢⚔️", "Un arma tan pesada que vibra con furia constante.", 2.25, 850, 6, "orco", "./Imagenes/orcos/mandoble_ira.png"),
                new Arma("Hacha Gemela de Sangre y Hueso 💀🩸", "Dos hachas que se cruzan y desgarran todo.", 2.15, 900, 7, "orco", "./Imagenes/orcos/hacha_gemela.png"),
                new Arma("Martillo de Guerra Maldito 🧿🔨", "Golpea con el peso de antiguas maldiciones.", 2.4, 950, 8, "orco", "./Imagenes/orcos/martillo_maldito.png"),
                new Arma("Espada Carnicera Infernal 🔥🗡️", "Diseñada para mutilar sin piedad, se alimenta del dolor.", 2.3, 1000, 9, "orco", "./Imagenes/orcos/espada_carnicera.png"),
                new Arma("Cuchillas de Guerra Huracanadas 🌪️🪓", "Crean una tormenta de sangre al girar en combate.", 2.5, 1100, 10, "orco", "./Imagenes/orcos/cuchillas_huracanadas.png")
            ...
            return [    //Armas de Magos
                ...
                new Arma("Varita de Llamas Eternas 🔥📜","Lanza fuego sin necesidad de palabras mágicas, perfecta para hechiceros agresivos.",2.05,600,3,"mago","./Imagenes/magos/varita_llamas.png"),
                new Arma("Báculo de Tormentas ⚡🌀","Un bastón que controla truenos y vientos, devastador contra grupos de enemigos.",2.10,750,4,"mago","./Imagenes/magos/baculo_de_tormentas.png"),
                new Arma("Espada del Arcano 🌀⚔️","Una espada flotante que se maneja con la mente.",1.95,750,4,"mago","./Imagenes/magos/espada_arcano.png"),
                new Arma("Cloak of Shadows 🖤🌑", "Una capa que permite al usuario volverse invisible en la oscuridad.", 1.9, 750, 5, "mago", "./Imagenes/magos/cloak_of_shadows.png"),
                new Arma("Orbe del Vacío ⚫🌌","Una esfera que absorbe energía y la libera como un rayo devastador.",2.20,800,6,"mago","./Imagenes/magos/orbe_del_vacio.png"),
                ...
                new Arma("Libro del Tiempo Fragmentado 📖⏳", "Manipula el flujo del tiempo durante el combate.", 2.0, 800, 6, "mago", "./Imagenes/magos/libro_tiempo.png"),
                new Arma("Varita del Eco Místico 🔁🪄", "Duplica hechizos lanzados una vez por combate.", 1.85, 850, 7, "mago", "./Imagenes/magos/varita_eco.png"),
                new Arma("Báculo de la Aurora Boreal 🌌💫", "Invoca luces que confunden y dañan.", 2.25, 900, 8, "mago", "./Imagenes/magos/baculo_aurora.png"),
                new Arma("Corona del Archimago 🔮👑", "Potencia la mente del portador y libera energía bruta.", 2.4, 1000, 9, "mago", "./Imagenes/magos/corona_archimago.png"),
                new Arma("Anillo del Vacío Infinito ⭕🖤", "Absorbe energía y la libera como una explosión mágica.", 2.5, 1100, 10, "mago", "./Imagenes/magos/anillo_vacio.png")
            ...
            return [    //Armas de Enanos
                ...
                new Arma("Martillo Lanzarrocas 🏹💥", "Un martillo que puede arrojar pequeños proyectiles de roca al golpear el suelo, afectando a múltiples enemigos a la vez.", 2.05,450,3,"enano","./Imagenes/enanos/martillo_lanzarrocas.png"),
                new Arma("Martillo Rompemontañas 🪨🔨","Un martillo de guerra tan pesado que solo un enano puede levantarlo. Golpea con la fuerza de una avalancha.",2.20,500,4,"enano","./Imagenes/enanos/martillo_rompemontanhas.png"),
                ...
                new Arma("Ballesta de Proyectiles de Acero ⚙️🎯", "Una ballesta que dispara virotes de acero como flechas, atravesando cualquier armadura.", 2.0, 650, 8, "enano", "./Imagenes/enanos/ballesta_proyectiles_acero.png"),
                new Arma("Martillo de la Fuerza Subterránea 🌑⚒️", "Un martillo que se empapó del poder de la tierra, causando terremotos con cada golpe.", 2.3, 750, 9, "enano", "./Imagenes/enanos/martillo_fuerza_subterranea.png"),

                new Arma("Cañón de Mano Rúnico 💥🔩", "Dispara balas encantadas que explotan al impactar.", 2.3, 850, 6, "enano", "./Imagenes/enanos/canon_runa.png"),
                new Arma("Hacha del Tajo Retumbante 🪓🔊", "Su golpe emite ondas sónicas que aturden.", 2.2, 900, 7, "enano", "./Imagenes/enanos/hacha_retumbo.png"),
                new Arma("Martillo Rúnico de Avalancha 🌨️🔨", "Invoca una ola de rocas tras cada golpe.", 2.4, 950, 8, "enano", "./Imagenes/enanos/martillo_avalancha.png"),
                new Arma("Escudo-Atrapavirotes 🛡️🎯", "Bloquea proyectiles y los redirige mágicamente.", 1.6, 1000, 9, "enano", "./Imagenes/enanos/escudo_atrapavirotes.png"),
                new Arma("Mandoble de Acero Estelar ✨⚔️", "Forjado con metal caído del cielo, irrompible.", 2.5, 1100, 10, "enano", "./Imagenes/enanos/mandoble_estelar.png")
            ...
            return [//Armas de Elfos
                ...
                new Arma("Bastón de Espíritus del Bosque 🌳✨","Un arma mágica que permite invocar bestias o curar aliados.",1.50,700,7,"elfo","./Imagenes/elfos/baston_espiritus_bosque.png"),
                ...
                new Arma("Lanza de la Aurora Verde 🌄🍃", "Brilla con la luz del bosque al amanecer.", 2.1, 800, 6, "elfo", "./Imagenes/elfos/lanza_aurora.png"),
                new Arma("Arco de las Lágrimas del Cielo 🌧️🏹", "Cada flecha cae como una gota que atraviesa todo.", 2.2, 850, 7, "elfo", "./Imagenes/elfos/arco_lluvia.png"),
                new Arma("Espadas de la Danza Etérea 💃⚔️", "Se mueven con una gracia letal, casi sin esfuerzo.", 2.15, 900, 8, "elfo", "./Imagenes/elfos/espadas_etereas.png"),
                new Arma("Dagas del Eclipse Total 🌑🗡️", "Solo se ven bajo la luna llena, pero siempre hieren.", 2.3, 950, 9, "elfo", "./Imagenes/elfos/dagas_eclipse.png"),
                new Arma("Bastón del Cántico Silvestre 🎼🌿", "Invoca melodías que sanan aliados o dañan enemigos.", 2.0, 1000, 10, "elfo", "./Imagenes/elfos/baston_cantico.png"),
